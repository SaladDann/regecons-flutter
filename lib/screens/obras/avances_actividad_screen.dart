...
class _AvancesActividadScreenState extends State<AvancesActividadScreen> {
  ...
  Future<String?> _seleccionarRutaFoto(BuildContext context) async {
    ...
    try {
      final XFile? imagen = await _picker.pickImage(source: source, imageQuality: 75);
      return imagen?.path;
    } catch (e) {
      _mensaje('Error al seleccionar la foto: $e', esError: true);
      return null;
    }
  }
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      String? path = await _seleccionarRutaFoto(context);
