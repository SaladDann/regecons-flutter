...
class _ObraDetalleScreenState extends State<ObraDetalleScreen>
  ...
  Future<void> _mostrarModalActividad({Actividad? actividad}) async {
    ...
    bool guardando = false; // Estado local del botón

    await showDialog<void>(
      context: context,
      barrierDismissible: false,
      builder: (context) => StatefulBuilder( // Permite actualizar el botón de GUARDAR
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: ['PENDIENTE', 'EN_PROGRESO', 'FINALIZADA']
                        .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                        .toList(),
                    onChanged: (v) => estado = v ?? 'PENDIENTE',
                  ),
                ],
              ),
            ),
            ...
            ElevatedButton(
              onPressed: guardando ? null : () async {
                ...
                try {
                  ...
                  // MEJORA UX: Cerramos y refrescamos inmediatamente
                  if (mounted) {
